    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.platforms.update", [$platform->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $platform->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $platform->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('extra_phone') ? 'is-invalid' : '' }}" type="text" name="extra_phone" id="extra_phone" value="{{ old('extra_phone', $platform->extra_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $platform->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" required>{{ old('address', $platform->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : '' }}" type="text" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $platform->facebook_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_url') ? 'is-invalid' : '' }}" type="text" name="youtube_url" id="youtube_url" value="{{ old('youtube_url', $platform->youtube_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twiter_url') ? 'is-invalid' : '' }}" type="text" name="twiter_url" id="twiter_url" value="{{ old('twiter_url', $platform->twiter_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linked_in_url') ? 'is-invalid' : '' }}" type="text" name="linked_in_url" id="linked_in_url" value="{{ old('linked_in_url', $platform->linked_in_url) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('about_us') ? 'is-invalid' : '' }}" name="about_us" id="about_us">{!! old('about_us', $platform->about_us) !!}</textarea>
