    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.upazilas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('police_station_name') ? 'is-invalid' : '' }}" type="text" name="police_station_name" id="police_station_name" value="{{ old('police_station_name', '') }}">
